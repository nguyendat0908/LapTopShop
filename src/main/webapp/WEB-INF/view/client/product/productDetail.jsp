...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>LapTopShop - Detail Product</title>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item active text-black">Chi tiết sản phẩm</li>
            </ol>
        </div>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="mb-3">Danh mục: ${product.factory}</p>
                                <p style="font-size: 15px; width: 100%;" class="text-dark  fw-bold mb-3">
                                    <fmt:formatNumber type="number" value="${product.price}" /> đ 
                                </p>
                                <p style="height: 15%;">${product.shortDesc}</p>
